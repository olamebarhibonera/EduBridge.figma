      ...
      <div className="p-6 space-y-6 theme-bg-secondary min-h-screen">
        ...
        <div className="bg-gradient-to-br from-blue-500 to-blue-600 rounded-2xl p-6 text-white shadow-lg">
          ...
          <div className="space-y-2 text-sm">
            <div className="flex items-center gap-2">
              ...
              <span>
                {userData.course} • {userData.university}
              </span>
            </div>
            <div className="flex items-center gap-2">
        ...
        {isAdmin && (
          <div className="relative overflow-hidden rounded-2xl">
            <div className="absolute inset-0 bg-gradient-to-r from-purple-500 via-amber-500 to-purple-500 opacity-90" />
            <button
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="text-left">
                  <div className="font-bold text-lg flex items-center gap-2">
                    Admin Dashboard
                    <span className="text-xs bg-amber-300 text-amber-900 px-2 py-0.5 rounded-full font-semibold">
                      VIP
                    </span>
                  </div>
...
// Temporary: Import from old location until full migration
export { Profile as ProfileScreen } from '../app/pages/Profile';
