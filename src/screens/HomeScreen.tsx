        ...
        <div className="p-6 space-y-6 -mt-6">
            ...
            return (
                ...
                >
                  <div className="theme-card rounded-2xl p-6 flex flex-col items-center justify-center gap-3 hover-lift overflow-hidden">
                    ...
                    <div
                      className={`bg-gradient-to-br ${action.color} p-4 rounded-xl shadow-lg ${action.glow} group-hover:shadow-2xl transition-all relative z-10`}
                    >
                  <Icon className="w-6 h-6 text-white" />
                </div>
                    <span className="text-sm font-semibold theme-text-primary relative z-10">
                      {action.label}
                    </span>
                  </div>
                </motion.button>
          ...
          <div className="grid grid-cols-2 gap-3">
              ...
              return (
                  ...
                  >
                    <div
                      className={`bg-gradient-to-br ${service.bg} rounded-2xl p-5 flex flex-col items-center justify-center gap-3 hover-lift border border-white/50`}
                    >
